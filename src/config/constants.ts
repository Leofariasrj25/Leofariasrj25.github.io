    ...
    projects: [
      {
        ...
        description: 'A chatbot integrated with historical football and other sports data to help bettors make more informed decisions. I led the team with emphasis on ideation, rapid prototyping team management, key feature coding, and validated MVP delivery.',
        bullets: [
      ...
      },
      {
        ...
        description: 'Technical case study from the Indicium Lighthouse program focused on transforming raw data into strategic business decisions. I built a complete ETL pipeline (Medallion Architecture) that served as the basis for identifying operational bottlenecks, analyzing profitability, and generating predictive models.',
        bullets: [
